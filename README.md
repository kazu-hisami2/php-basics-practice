...
- 消費税率（百分率）{$tax_rate * 100}を文字列内に組み込んで表示させたかったですが、
  難しそうだったので$tax_per = $tax_rate * 100と定義し文字列に組み込みました。
...
## 動作確認のスクショ
<img width="1088" height="947" alt="Image" src="https://github.com/user-attachments/assets/37007fa6-93f2-411a-8543-bd26afdb0a5d" />
